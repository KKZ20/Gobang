  ...
  <div class="home">
    ...
    <div class="status">
      <div class="status-inner">
        <div :class="'chessman '+(first === 1 ? 'black' : 'white')"></div>
        {{statusText}}
      </div>
    </div>
    ...
    <div class="weui-flex operations">
      ...
      <div class="weui-flex__item">
        <a
          href="javascript:;"
          :class="'weui-btn weui-btn_plain-primary ' + (canRestart() ? '' : 'weui-btn_plain-disabled')"
    ...
    <!-- 确定认输对话框 -->
    <Dialog ref="give" :title="$t('dialog.giveTitle')" :body="$t('dialog.giveBody')">
      <a
        href="javascript:;"
        class="weui-dialog__btn weui-dialog__btn_primary"
        @click="give"
      ...
      <a
        ...
        @click="$refs.give.close()"
      >{{$t('dialog.cancel')}}</a>
    </Dialog>

    <!-- 确定重新开始对话框-->
    <Dialog ref="restart" :title="$t('dialog.restartTitle')" :body="$t('dialog.restartBody')">
      <a
        href="javascript:;"
        class="weui-dialog__btn weui-dialog__btn_primary"
        @click="restart"
